...
from core.consts.currencies import BEP20_CURRENCIES, ERC20_CURRENCIES, TRC20_CURRENCIES, CURRENCIES_LIST, \
    CRYPTO_ADDRESS_VALIDATORS, ERC20_MATIC_CURRENCIES, ERC20_WON_CURRENCIES, ERC20_CELO_CURRENCIES, ERC20_CORE_CURRENCIES, ERC20_FUSE_CURRENCIES, ERC20_AVAX_CURRENCIES,ERC20_ETC_CURRENCIES,ERC20_FTM_CURRENCIES,ERC20_DAI_CURRENCIES
...
def prompt_contract(blockchain):
    while 1:
        ...
        if not check_address(blockchain, contract, blockchain):
            ...
            continue
        if blockchain in ['ETH', 'BNB', 'MATIC', 'WON', 'CELO', 'CORE', 'FUSE', 'AVAX','ETC','FTM','DAI']:
