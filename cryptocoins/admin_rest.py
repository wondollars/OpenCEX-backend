...
from core.consts.currencies import BEP20_CURRENCIES, BEP20_WON_CURRENCIES, ERC20_MATIC_CURRENCIES
...
from cryptocoins.models.proxy import BNBWithdrawalApprove, MaticWithdrawalApprove,WONWithdrawalApprove
...
class WONWithdrawalApproveApiAdmin(BaseWithdrawalApprove):
    def get_queryset(self):
        return get_withdrawal_requests_to_process([WON_CURRENCY, *BEP20_WON_CURRENCIES], blockchain_currency='WON')
