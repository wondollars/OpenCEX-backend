...
WON_SAFE_ADDR = env('WON_SAFE_ADDR')
...
WON_CHAIN_ID = 686868
WON_TX_GAS = 21000
WON_BEP20_ACCUMULATION_PERIOD = 60
WON_BLOCK_GENERATION_TIME = 15
WON_GAS_PRICE_UPDATE_PERIOD = 60
WON_GAS_PRICE_COEFFICIENT = 0.1
WON_MAX_GAS_PRICE = 300000000000
WON_MIN_GAS_PRICE = 5000000000
WON_RPC_ENDPOINTS = [
...
ETHERSCAN_KEY = env('ETHERSCAN_KEY', default='S1A72BKRI9FXF24J3PMYY2TV28G1Q5PN5J')
BSCSCAN_KEY = env('BSCSCAN_KEY', default='P4X2EVKCNTHSRTIHHRMZ45661ITEXKKZDF')
WONSCAN_KEY = env('WONSCAN_KEY', default='29b1b996-ed19-413e-bd68-edd9bc49b43a')
POLYGONSCAN_KEY = env('POLYGONSCAN_KEY', default='B9IG9RC6EPZ5TG53FJB51AN8DMD76VG3J4')
