...
VUE_ADMIN_SIDE_MENU = [
    ...
    {'icon': 'mdi-coins', 'link': {'name': 'cryptocoins_celowithdrawalapprove_list'}, 'text': 'Celo Withdrawal Approve'},
    {'icon': 'mdi-coins', 'link': {'name': 'cryptocoins_corewithdrawalapprove_list'}, 'text': 'Core Withdrawal Approve'},
    {'icon': 'mdi-coins', 'link': {'name': 'cryptocoins_fusewithdrawalapprove_list'}, 'text': 'Fuse Withdrawal Approve'},
    {'icon': 'mdi-coins', 'link': {'name': 'cryptocoins_avaxwithdrawalapprove_list'}, 'text': 'Avax Withdrawal Approve'},
