    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('amount_in_orders', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
            ],
        ),
        migrations.CreateModel(
            name='CoinInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('diff', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('diff_percent', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('balance', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('old_balance', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('calc_balance', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('txs_amount', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('sum_diff', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cost', lib.fields.MoneyField(decimal_places=12, max_digits=32)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', lib.fields.MoneyField(decimal_places=12, max_digits=32)),
                ('fee_rate', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('price', lib.fields.MoneyField(decimal_places=12, max_digits=32, null=True)),
                ('matched_order_price', lib.fields.MoneyField(decimal_places=12, max_digits=32, null=True)),
                ('fee_amount', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
            ],
        ),
        migrations.CreateModel(
            name='ExpiringToken',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('pair', core.pairs.PairModelField()),
                ('price', lib.fields.MoneyField(blank=True, decimal_places=12, max_digits=32, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='FeesAndLimits',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('currency', core.currency.CurrencyModelField(unique=True)),
                ('limits_deposit_min', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('limits_deposit_max', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('limits_withdrawal_min', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('limits_withdrawal_max', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('limits_order_min', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('limits_order_max', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('limits_code_max', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('limits_accumulation_min', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('fee_deposit_address', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('fee_deposit_code', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('fee_withdrawal_code', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('fee_order_limits', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('fee_order_market', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('fee_exchange_value', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
            ],
        ),
        migrations.CreateModel(
            name='InoutsStats',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('currency', core.currency.CurrencyModelField()),
                ('deposits', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('withdrawals', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
            ],
        ),
        migrations.CreateModel(
            name='LoginHistory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantity', lib.fields.MoneyField(decimal_places=12, max_digits=32)),
                ('price', lib.fields.MoneyField(decimal_places=12, max_digits=32, null=True)),
                ('cost', lib.fields.MoneyField(blank=True, decimal_places=12, max_digits=32, null=True)),
                ('price_ts', models.DateTimeField(auto_now_add=True)),
                ('quantity_left', lib.fields.MoneyField(decimal_places=12, max_digits=32)),
                ('vwap', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('otc_limit', lib.fields.MoneyField(blank=True, decimal_places=12, max_digits=32, null=True)),
                ('otc_percent', lib.fields.MoneyField(blank=True, decimal_places=12, max_digits=32, null=True)),
                ('stop', lib.fields.MoneyField(blank=True, decimal_places=12, max_digits=32, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('quantity', lib.fields.MoneyField(blank=True, decimal_places=12, max_digits=32, null=True)),
                ('price', lib.fields.MoneyField(blank=True, decimal_places=12, max_digits=32, null=True)),
                ('otc_percent', lib.fields.MoneyField(blank=True, decimal_places=12, max_digits=32, null=True)),
                ('otc_limit', lib.fields.MoneyField(blank=True, decimal_places=12, max_digits=32, null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_price', lib.fields.MoneyField(decimal_places=12, default=0.0, max_digits=32)),
                ('deviation', models.DecimalField(decimal_places=12, default=0.0, help_text='Max order price deviation', max_digits=12)),
            ],
        ),
        migrations.CreateModel(
            name='PayGateTopup',
            fields=[
                ...
                ('our_fee_amount', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('status', models.PositiveSmallIntegerField(choices=[(0, 'Not set'), (99, 'Reverted')], default=0)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('min_price', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('max_price', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('avg_price', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('open_price', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('close_price', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('volume', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('amount', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
                ('num_trades', models.IntegerField(default=0)),
                ('fee_base', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('fee_quoted', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('fee_rate', lib.fields.MoneyField(blank=True, decimal_places=12, default=0.002, max_digits=32, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='UserFee',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(auto_now_add=True)),
                ('fee_rate', lib.fields.MoneyField(blank=True, decimal_places=12, default=0.001, max_digits=32, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='UserKYC',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('volume_got1', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('volume_got2', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('fee_amount_paid1', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('fee_amount_paid2', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('volume_spent1', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('volume_spent2', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address_fee', models.DecimalField(decimal_places=12, default=0, max_digits=32)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency', core.currency.CurrencyModelField()),
                ('amount', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
                ('amount_usdt', lib.fields.MoneyField(decimal_places=12, default=0, max_digits=32)),
