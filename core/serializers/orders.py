...
class OTCSerializer(serializers.Serializer):
    otc_percent = serializers.DecimalField(max_digits=32, decimal_places=12)
    otc_limit = serializers.DecimalField(max_digits=32, decimal_places=12)
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    quantity = serializers.DecimalField(max_digits=32, decimal_places=12)
...
class ExchangeResultSerialzier(serializers.ModelSerializer):
    ...
    cost = serializers.DecimalField(max_digits=32, decimal_places=12)
    quantity = serializers.DecimalField(max_digits=32, decimal_places=12)
...
class ExchangeRequestSerializer(serializers.Serializer):
    ...
    base_currency = CurrencySerialField()
    quote_currency = CurrencySerialField()
    quantity = serializers.DecimalField(min_value=0, max_digits=32, decimal_places=12, required=False)
    quantity_alt = serializers.DecimalField(min_value=0, max_digits=32, decimal_places=12, required=False)
...
class UpdateOrderSerializer(serializers.Serializer):
    ...
    stop = serializers.DecimalField(min_value=0, required=False, max_digits=32, decimal_places=12)
    quantity = serializers.DecimalField(min_value=0, required=False, max_digits=32, decimal_places=12)
    otc_limit = serializers.DecimalField(min_value=0, required=False, max_digits=32, decimal_places=12)
    otc_percent = serializers.DecimalField(required=False, max_digits=32, decimal_places=12)
