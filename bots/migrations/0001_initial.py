    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('main_exchange_price', lib.fields.MoneyField(decimal_places=16, max_digits=32)),
                ('binance_price', lib.fields.MoneyField(decimal_places=16, max_digits=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('btc_change', lib.fields.MoneyField(decimal_places=16, max_digits=32)),
                ('eth_change', lib.fields.MoneyField(decimal_places=16, max_digits=32)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pair', core.pairs.PairModelField()),
                ('quantity', lib.fields.MoneyField(decimal_places=16, max_digits=32)),
                ('price', lib.fields.MoneyField(decimal_places=16, max_digits=32)),
                ('side', models.PositiveSmallIntegerField(choices=[(1, 'Buy'), (2, 'Sell')], default=1)),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deals', models.PositiveIntegerField(default=0)),
                ('pair', core.pairs.PairModelField()),
                ('total_buy', lib.fields.MoneyField(decimal_places=16, max_digits=32)),
                ('total_sell', lib.fields.MoneyField(decimal_places=16, max_digits=32)),
                ('change', lib.fields.MoneyField(decimal_places=16, max_digits=32)),
            ],
        ),
        migrations.CreateModel(
            name='BotConfig',
            fields=[
                ...
                ('ext_price_delta', lib.fields.MoneyField(decimal_places=16, default=0.001, max_digits=32)),
                ('min_order_quantity', lib.fields.MoneyField(decimal_places=16, default=0.1, max_digits=32)),
                ('max_order_quantity', lib.fields.MoneyField(decimal_places=16, default=0.5, max_digits=32)),
                ...
                ('custom_price', lib.fields.MoneyField(decimal_places=16, default=0, max_digits=32)),
                ...
                ('liquidity_min_btc_balance', lib.fields.MoneyField(decimal_places=16, default=0, max_digits=32)),
                ('liquidity_min_eth_balance', lib.fields.MoneyField(decimal_places=16, default=0, max_digits=32)),
                ('liquidity_min_usdt_balance', lib.fields.MoneyField(decimal_places=16, default=0, max_digits=32)),
